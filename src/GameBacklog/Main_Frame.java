...
public final class Main_Frame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		GamesPanelLayout.setHorizontalGroup(GamesPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(GamesPanelLayout.createSequentialGroup().addContainerGap()
						.addGroup(GamesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(GamesPanelCombo, javax.swing.GroupLayout.Alignment.TRAILING, 0,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(ShowGameTypeButton, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(GamesPanelLayout.createSequentialGroup()
										.addComponent(GamesPanelInsertButton, javax.swing.GroupLayout.PREFERRED_SIZE,
												63, javax.swing.GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(GamesPanelUpdateButton, javax.swing.GroupLayout.PREFERRED_SIZE,
								...
								.addComponent(GamesPanelLogTimeButton, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(GamesPanelLayout.createSequentialGroup()
										.addGroup(GamesPanelLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
												.addComponent(AllGames, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(PrintGamesButton, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
										.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
										.addGroup(GamesPanelLayout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
												.addComponent(GamestoFileButton, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(AllGamestoFileButton,
														javax.swing.GroupLayout.DEFAULT_SIZE, 103, Short.MAX_VALUE)))
								.addGroup(GamesPanelLayout.createSequentialGroup().addGap(51, 51, 51)
										.addComponent(GamePanelLabel).addGap(0, 0, Short.MAX_VALUE)))
						.addContainerGap()));
		GamesPanelLayout.setVerticalGroup(GamesPanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(GamesPanelLayout.createSequentialGroup().addContainerGap().addComponent(GamePanelLabel)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(GamesPanelCombo, javax.swing.GroupLayout.PREFERRED_SIZE,
						...
						.addGroup(GamesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(GamesPanelInsertButton).addComponent(GamesPanelUpdateButton)
								.addComponent(GamesPanelDeleteButton))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(GamesPanelLogTimeButton)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(GamesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(PrintGamesButton).addComponent(GamestoFileButton))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addGroup(GamesPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(AllGames).addComponent(AllGamestoFileButton))
						.addContainerGap()));
		...
		GamesPanelCombo.addItemListener(new java.awt.event.ItemListener() {
			public void itemStateChanged(java.awt.event.ItemEvent evt) {
				GamesPanelComboItemStateChanged(evt);
			}
		});
		...
		ConsolePanelLayout.setHorizontalGroup(ConsolePanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(ConsolePanelLayout.createSequentialGroup().addContainerGap().addGroup(ConsolePanelLayout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(ConsolesPanelLogTimeButton, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(ShowConsoleTypeButton, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						...
						.addGroup(ConsolePanelLayout.createSequentialGroup()
								.addComponent(ConsolesPanelInsertButton, javax.swing.GroupLayout.PREFERRED_SIZE, 63,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(ConsolesPanelUpdateButton, javax.swing.GroupLayout.PREFERRED_SIZE, 62,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(ConsolesPanelDeleteButton, javax.swing.GroupLayout.DEFAULT_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
						.addGroup(ConsolePanelLayout.createSequentialGroup()
								.addComponent(PrintConsolesButton, javax.swing.GroupLayout.PREFERRED_SIZE, 95,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(ConsolestoFileButton, javax.swing.GroupLayout.PREFERRED_SIZE, 0,
										Short.MAX_VALUE)))
						.addContainerGap())
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						ConsolePanelLayout.createSequentialGroup()
								.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(ConsolesPanelLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 152,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addGap(35, 35, 35)));
		ConsolePanelLayout.setVerticalGroup(ConsolePanelLayout
				.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(ConsolePanelLayout.createSequentialGroup().addContainerGap().addComponent(ConsolesPanelLabel)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(ConsolesPanelCombo, javax.swing.GroupLayout.PREFERRED_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(ShowConsoleTypeButton).addGap(12, 12, 12)
						.addGroup(ConsolePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(ConsolesPanelInsertButton).addComponent(ConsolesPanelUpdateButton)
								.addComponent(ConsolesPanelDeleteButton))
						.addGap(12, 12, 12).addComponent(ConsolesPanelLogTimeButton)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(ConsolePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(ConsolestoFileButton).addComponent(PrintConsolesButton))
						.addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
								...
								.addGroup(layout.createSequentialGroup()
										.addGroup(layout
												...
												.addComponent(jScrollPane2, javax.swing.GroupLayout.PREFERRED_SIZE, 0,
														Short.MAX_VALUE)
												.addComponent(ConsolePanel, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
										.addGap(18, 18, 18)
										.addGroup(layout
												.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
												.addComponent(GamesPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 0,
														Short.MAX_VALUE))
										.addGap(0, 0, Short.MAX_VALUE))))
						.addComponent(AccountsButton, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
				.addContainerGap()));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				...
				layout.createSequentialGroup().addContainerGap()
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(WelcomeLabel).addComponent(LogoutButton,
										javax.swing.GroupLayout.PREFERRED_SIZE, 38,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(GamesPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 240,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(ConsolePanel, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
	...
	{// GEN-HEADEREND:event_ShowConsoleTypeButtonActionPerformed
		...
		InformationConsoleTextArea
				.setText("Name = " + selected_item.getName() + "\n" + "Type =  " + selected_item.getType());
	...
	{// GEN-HEADEREND:event_ConsolestoFileButtonActionPerformed
		try {
			fos = new FileOutputStream(new File("Consoles" + Classes.StaticUser.GetUsername() + ".txt"));
	...
	{// GEN-HEADEREND:event_GamestoFileButtonActionPerformed
		try {
			fos = new FileOutputStream(new File("games" + Classes.StaticUser.GetUsername() + ".txt"));
			out = new PrintWriter(fos);
	...
	{// GEN-HEADEREND:event_AllGamestoFileButtonActionPerformed
		try {
			fos = new FileOutputStream(new File("AllGames" + Classes.StaticUser.GetUsername() + ".txt"));
			out = new PrintWriter(fos);
	...
	{// GEN-HEADEREND:event_ConsolesPanelComboItemStateChanged
		...
		if (ConsoleID == 0)
			AreConsoleButtonsEnabled(false);
		else
			AreConsoleButtonsEnabled(true);

		GameCombo();
	}// GEN-LAST:event_ConsolesPanelComboItemStateChanged

	private void GamesPanelComboItemStateChanged(java.awt.event.ItemEvent evt) 
	{
		Game item = (Game) GamesPanelCombo.getSelectedItem();
		int ID = item.getId();

		if (ID == 0)
			AreGamesButtonsEnabled(false);
		else
			AreGamesButtonsEnabled(true);
	}
	...
	private void ConsoleCombo() {
		try {
			...
			Console defaultitem = new Console(0, "", "<Please Select>");
			ConsolesPanelCombo.addItem(defaultitem);
			...
			JOptionPane.showMessageDialog(null, "Encountered a problem with console menu. Please try again later" + ex);
		} finally {
			try {
				connection.close();
			} catch (Exception ex) {
				JOptionPane.showMessageDialog(null,
						"Encountered a problem closing connection for console menu.  Please try again later");
			}
		}
	}

	@SuppressWarnings("unchecked")
	private void GameCombo() {
		try {
			connection = DB_Connection.Connect();
			...
			if (ConsoleID > 0) {
				...
				callablestatement = connection.prepareCall(SQL);
				callablestatement.setInt(1, ConsoleID);
				ResultSet res = callablestatement.executeQuery();

				Game defaultitem = new Game(0, "", "", "<Please Select>");
				GamesPanelCombo.addItem(defaultitem);
			...
			try {
				...
				JOptionPane.showMessageDialog(null,
						"Encountered a problem closing connection for game menu.  Please try again later");
			}
		}
	}

	private static String print(ResultSet resultSet) {
		String results = "";
		try {
			...
			JOptionPane.showMessageDialog(null,
					"Encountered a problem with printing the results.  Please try again later");
		}
		return results;
	}

	private void AreConsoleButtonsEnabled(boolean IsEnabled) {
		ConsolesPanelDeleteButton.setEnabled(IsEnabled);
		ConsolesPanelLogTimeButton.setEnabled(IsEnabled);
		ConsolesPanelUpdateButton.setEnabled(IsEnabled);
		ConsolestoFileButton.setEnabled(IsEnabled);
		PrintConsolesButton.setEnabled(IsEnabled);
		ShowConsoleTypeButton.setEnabled(IsEnabled);
	}

	private void AreGamesButtonsEnabled(boolean IsEnabled) {
		GamesPanelDeleteButton.setEnabled(IsEnabled);
		GamesPanelLogTimeButton.setEnabled(IsEnabled);
		GamesPanelUpdateButton.setEnabled(IsEnabled);
		GamestoFileButton.setEnabled(IsEnabled);
		PrintGamesButton.setEnabled(IsEnabled);
		ShowGameTypeButton.setEnabled(IsEnabled);
		AllGames.setEnabled(IsEnabled);
		AllGamestoFileButton.setEnabled(IsEnabled);
	}
